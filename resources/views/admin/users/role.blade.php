                ...
                <div class="mt-6 p-2">
                    ...
                    <div class="flex space-x-2 mt-4 p-2">
                        @if ($user->roles)
                            ...
                            <form method="POST" class="px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md" action="{{ route('admin.roles.permissions.revoke', [$user->id, $user_role->id]) }}" onsubmit="return confirm('Are you sure?');">
                                @csrf
                                @method('DELETE')
                    ...
                    <div class="mt-6 p-2 bg-slate-100">
                        ...
                        <div class="flex space-x-2 mt-4 p-2">
                            @if ($user->permissions)
                                ...
                                <form class="px-4 p-2 bg-red-500 hover:bg-red-700 text-white rounded-md" method="POST"
                        ...
                        <div class="max-w-xl mt-6">
                            <form method="POST" action="{{ route('admin.users.permissions', $user->id) }}">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <select name="permission" name="permission" autocomplete="permission-name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md">
